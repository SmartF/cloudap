...
#endif /* CONFIG_HS20 */
	//fprintf(stdout,"u.beacon.variable[0]: %x\n\n\n\n",(unsigned short)head->u.probe_req.variable[0]);
 	wpa_hexdump(MSG_DEBUG, "nl80211ext: params->head:%s\n",params.head,params.head_len);
 	wpa_hexdump(MSG_DEBUG, "nl80211ext: params->tail:%s\n",params.tail,params.tail_len);
